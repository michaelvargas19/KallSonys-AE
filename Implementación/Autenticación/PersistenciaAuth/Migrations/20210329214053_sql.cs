    ...
    public partial class sql : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "Manager", "HmacSha512", "", true, true, new DateTime(2023, 3, 29, 16, 40, 52, 128, DateTimeKind.Local).AddTicks(2253), "", 60.0, "Account Service", true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "dbfd45b8-7fa6-457d-8439-3f53ebdc3b22", "", "PowerUser", "Manager", "PowerUser", "POWERUSER" },
                    { 2, "e52f02f2-a553-426e-83e4-73dd07c55298", "", "Administrador", "Manager", "Administrador", "ADMINISTRADOR" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/system", "Manager", 1 });

            migrationBuilder.InsertData(
                table: "AspNetRoleClaims",
                columns: new[] { "Id", "ClaimType", "ClaimValue", "RoleId" },
                values: new object[] { 2, "http://schemas.xmlsoap.org/ws/2005/05/identity/claims/system", "Manager", 2 });
