    ...
    public class ContextoAuthDB : IdentityDbContext<Usuario, Rol, int, IdentityUserClaim<int>, IdentityUserRole<int>, IdentityUserLogin<int>, IdentityRoleClaim<int>, Token>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Rol>().HasData(
                            new Rol() { Id = 1, Name = "PowerUser", NormalizedName = "POWERUSER", IdAplicacion = "Manager", Display = "PowerUser", Descripcion = "" }
                         );

            builder.Entity<Rol>().HasData(
                            new Rol() { Id = 2, Name = "Administrador", NormalizedName = "ADMINISTRADOR", IdAplicacion = "Manager", Display = "Administrador", Descripcion = "" }
                         );
